...
public class VisorUB4 extends javax.swing.JFrame {
    ...
    /**
     * Classe que fa un JFrame per afegir una imatge a la biblioteca
     */
    ...
    /**
     * Classe que fa un JFrame per afegir un album al visor
     */
    ...
    /**
     * Classe que crea un frame per obtenir una ruta de dades
     */
    ...
    /**
     * Classe que serveix per actualitzar les dades del visor
     */
    class Actualitzador{
        private VisorUB4 visor;
    ...
    private void initComponents() {
        ...
        btnPausePlay = new javax.swing.JToggleButton();
        btnMenys = new javax.swing.JButton();
        ...
        btnMenys.setText("-");
        btnMenys.addActionListener(new java.awt.event.ActionListener() {
            public void actionPerformed(java.awt.event.ActionEvent evt) {
                btnMenysActionPerformed(evt);
            }
        });
        ...
        lblFreq.setText("\"Imatge cada 2 segons\"");
        ...
        layout.setHorizontalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addGroup(javax.swing.GroupLayout.Alignment.TRAILING, layout.createSequentialGroup()
                        .addContainerGap(javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                        .addComponent(btnMenys)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                        .addComponent(lblFreq, javax.swing.GroupLayout.PREFERRED_SIZE, 130, javax.swing.GroupLayout.PREFERRED_SIZE)
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(btnMes)
                        .addGap(37, 37, 37)
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGap(18, 18, 18)
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING, false)
                    .addComponent(btnGuardarDades, javax.swing.GroupLayout.DEFAULT_SIZE, 31, Short.MAX_VALUE)
                    .addComponent(btnRecuperarDades, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE))
                .addContainerGap())
        );
    ...
    private void btnMenysActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnMenysActionPerformed
        try {
                    this.controlador.changeSpeed(false);
                    this.lblFreq.setText("Imatge cada "+Float.toString(this.controlador.getPlayFrequency()/1000)+" segons");
                } catch (VisorException ex) {
                    JOptionPane.showMessageDialog(null, ex.getMessage());
                }
    }//GEN-LAST:event_btnMenysActionPerformed
    ...
    private void btnPausePlayActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnPausePlayActionPerformed
        try {
                    this.controlador.changeReprodStatus();
                    if(this.btnPausePlay.isSelected()){
                        this.btnPausePlay.setText(">");
                    }else{
                        this.btnPausePlay.setText("||");
                    }
    ...
    }//GEN-LAST:event_btnPausePlayActionPerformed
    ...
    private javax.swing.JButton btnMenys;
    private javax.swing.JButton btnMes;
    private javax.swing.JToggleButton btnPausePlay;
