                ...
                if(!this.controlador.getDialogStatus()){
                    ...
                    switch(opcio){
                        case REPROD_INCREMENTAR_VELOCITAT:
                            ...
                            System.out.println("Incrementem la velocitat en 0,25 segons");
                            System.out.println("Velocitat"+(this.controlador.getPlayFrequency()/1000));
                            break;
                        case REPROD_DECREMENTAR_VELOCITAT:
                            this.controlador.changeSpeed(false);
                            System.out.println("Decrementem la velocitat en 0,25 segons");
                            System.out.println("Velocitat"+(this.controlador.getPlayFrequency()/1000));
                            break;
